...
class MovieLens:
    movieID_to_name={}
    name_to_movieID={}
    ratings='Movielens dataset/ratings.csv'
    ...
    def loadDataset(self):
        ...
        ratingsDataset = Dataset.load_from_file(self.ratings, reader=reader)
...
#     function to get genres
    ...
    # Function to get movie IDs and movie names
