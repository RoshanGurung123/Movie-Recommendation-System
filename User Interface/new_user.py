...
def add_rating():
    st.sidebar.write("Rate al least 10 movies for better recommendation")
    movie_name=st.sidebar.selectbox("Select a movie to add",all_movie_names)
    ratings=st.sidebar.slider("Select a rating", min_value=1, max_value=5)

# implementing the genre based content-based filtering and popularity based recommendatiob system
